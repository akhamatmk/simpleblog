                              ...
                              <div class="card h-100">
                                ...
                                <div class="single-post post-style-2 post-style-3">
                                    ...
                                    <div class="blog-info">
                                        ...
                                        <h6 class="pre-title"><a href="{{ url('category/'.$value['category']->name) }}"><b>{{ $value['category']->name }}</b></a></h6>
                                        ...
                                        <div class="avatar-area">
                                            <a class="avatar" href="{{ url('detail/post/'.$value['alias']) }}"><img src="{{ $value['createdby']['image'] }}" alt="Profile Image"></a>
